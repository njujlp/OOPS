...
#ifndef FV3GFS_MODEL_FV3GFSFIELDS_H_
#define FV3GFS_MODEL_FV3GFSFIELDS_H_
...
// -----------------------------------------------------------------------------
/// Class to represent a FieldSet for the FV3GFS model
class Fields : public util::Printable,
                 private util::ObjectCounter<Fields> {
 public:
  static const std::string classname() {return "fv3gfs::Fields";}
...
#endif  // FV3GFS_MODEL_FV3GFSFIELDS_H_
